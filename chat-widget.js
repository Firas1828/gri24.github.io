  ...
  `;
    ...
    <div id="chat-popup" class="hidden absolute bottom-20 right-0 w-96 bg-white rounded-md shadow-md flex flex-col transition-all text-sm">
      <div id="chat-header" class="flex justify-between items-center p-4 bg-purple-800 text-white">
        <h3 class="m-0 text-lg">GRI Chat Support</h3>
  ...
  <div class="typing-loader"></div>
      ...
      <div id="chat-input-container" class="p-4 border-t border-purple-200">
        ...
        <div class="flex text-center text-xs pt-4">
          <span class="flex-1">Powered by <a href="" target="_blank" class="text-purple-600">@AKhojah</a></span>
        </div>
      </div>
    </div>
  `;
    ...
    `;
        ...
        let OPENAI_API_KEY = "AIzaSyBPqfADoeOZRBS7K1nkQ7B5vMIgdhcecoc";
        ...
        reply("This is an example for GRI")
    }
